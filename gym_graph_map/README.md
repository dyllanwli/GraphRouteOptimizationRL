...
There is a third deprecated environment in which each node has the same number of neighbors, such that the full action space is valid. This can be found in the [source code](./gym_graph_map/envs/graph_search_env.py#248).
...
There are also finer knobs available: covariance and clipping. These can be found in the [source code](./gym_graph_map/envs/graph_search_env.py#L97).
